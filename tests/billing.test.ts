...
import { getGasSubmeterUsage } from '../src/common/encompass-io-api-client'

jest.mock('../src/common/encompass-io-api-client'); 
...
describe('PG&E Billing', () => {
    ...
    test('given pg&e gas page given - gas bill and dates extracted', async () => {
        ...
        jest.mocked(getGasSubmeterUsage).mockResolvedValue(5.0);
        
        // act
        const bill = await calculateGasBill(pages);
        
        // verify
        expect(getGasSubmeterUsage).toHaveBeenCalled();
